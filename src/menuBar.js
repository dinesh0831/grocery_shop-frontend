    ...
    return (
        <div>
            <Box sx={{ bgcolor: "blue", height: 50, display: "flex", alignItems: "center", }}>
                ...
                <IconButton component={Link} to="/cart" sx={{ margin: 3 }}><Badge overlap="circular" variant="dot" color="success" size="small"  ><ShoppingCartSharpIcon sx={{ fontSize: 24, color: "white", }} /></Badge></IconButton>
